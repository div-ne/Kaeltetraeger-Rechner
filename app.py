...
with st.expander("Anleitung"):
    st.markdown(
        """
        Diesen Tool dient zur Umrechnung von den Kennwerten eines hydraulischen Systems mit einem Kälteträger in die Kennwerte eines anderen Kälteträgers.
        ...
        Folgende Kälteträger sind verfügbar:
        - Wasser
        - Antifrogen N (Glykolgemisch auf Basis von Monoethylenglykol)
        - Antifrogen L (Glykolgemisch auf Basis von Propylenglykol)
        - Antifrogen Kaliumformiat (Salzlösung auf Basis von Kaliumformiat)

        Repository: https://github.com/div-ne/Kaeltetraeger-Rechner
        """
    )
