...
title_col, version_col = st.columns([0.35, 0.65], vertical_alignment="bottom")
with title_col:
    st.title(APP_TITLE)
with version_col:
    st.markdown(f"<div style='color:#9ca3af;font-size:0.95rem;padding-top:1.4rem;'>Version {APP_VERSION}</div>", unsafe_allow_html=True)
